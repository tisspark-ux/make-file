...
def build(wb, year: int = 2026):
    ...
    ann_colors  = ["3D5470", "3D5470", "4D7063", "8C5858", "5B7490", "5B7490"]
    ...
    hm_colors  = ["3D5470", "3D5470"] + ["4D7063"] * 12 + ["8C5858"]
    ...
    for i, (main_cat, sub_cat, *_) in enumerate(BUDGET_ITEMS):
        ...
        for ci, val in [(2, main_cat), (3, sub_cat)]:
            c = ws.cell(row=row, column=ci, value=val)
            c.fill = _fill("F5F7F9" if i % 2 == 0 else "FFFFFF")
            c.alignment = _align()
            c.border = _border()
    ...
    ws.conditional_formatting.add(
        ...
        ColorScaleRule(
            ...
            end_type="percentile", end_value=100,      end_color="8C5858"
        )
    )
...
def _add_annual_chart(ws, header_row, data_start, data_end, anchor_row):
    ...
    bar.series[0].graphicalProperties.solidFill = "5B7490"
